            ...
            delegate: SliverChildListDelegate(
              [
                ...
                ListTile(
                  ...
                  subtitle: const Text('测试应用内 URL 加载功能'),
                  trailing: const Icon(FluentIcons.globe_24_regular),
                  onTap: () {
                ...
                ListTile(
                  title: const Text('测试 示例'),
                  subtitle: const Text('在应用内浏览 访问'),
                  trailing: const Icon(FluentIcons.code_24_regular),
                  onTap: () {
                    WebViewService.openUrl(
                      context,
                      url: 'https://www.cmdh1uz.com',
                      title: '草莓',
                    );
                  },
                ),
